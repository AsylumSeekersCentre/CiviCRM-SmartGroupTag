...
At present, it expects one tag to apply to only one group. Multiple tags can be applied to the same group. This limitation should be fixed in future versions.
